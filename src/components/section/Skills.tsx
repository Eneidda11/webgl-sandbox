...
const Skills = () => {
  ...
  return (
    <section ref={sectionRef} id="skills" className="min-h-screen py-20 relative overflow-hidden" style={{
      ...
      <div className="container mx-auto px-6 relative" style={{ zIndex: 2 }}>
        <h2 className="text-3xl font-bold tracking-tight mb-12 text-center font-mono" style={{ color: isDarkMode ? themeColors.colors.white : themeColors.colors.pink[500] }}>
          ./TECH_STACK
        </h2>
